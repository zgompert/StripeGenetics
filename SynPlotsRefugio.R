...
## read synteny dat
ff<-list.files(pattern="out_ca")
#[1] "out_cactusTcrGSR1_TcrGS.psl"     "out_cactusTcrGSR1_TcrGSR2.psl"
#[3] "out_cactusTcrGSR1_TcrGUSR1.psl"  "out_cactusTcrGSR1_TcrGUSR2.psl"
#[5] "out_cactusTcrGSR2_TcrGUSR1.psl"  "out_cactusTcrGSR2_TcrGUSR2.psl"
#[7] "out_cactusTcrGUSR1_TcrGUS.psl"   "out_cactusTcrGUSR1_TcrGUSR2.psl"

crisSizeGS<-c(69933647,70603406,147781425,151833030,69672476,72868255,63432198,97122551,69324240,68842367,65852211,38417004,134256509)
...
dat_gsr1_gs<-fread(ff[[1]],header=FALSE)
...
par(mar=c(5,5,1,1))
image(ntab,axes=FALSE,xlab="T. cristinae (GS)",ylab="T. cristinae (R GS1)",cex.lab=1.4)
...
#dat_gsr1_gsr2<-fread("PslFiles/out_cactusTcrGSR1_TcrGSR2.psl",header=FALSE)
...
par(mar=c(5,5,1,1))
image(ntab,axes=FALSE,xlab="T. cristinae (R GS2)",ylab="T. cristinae (R GS1)",cex.lab=1.4)
axis(2,at=seq(0,13,length.out=13)/13,tc_gsr1,las=2)
...
pdf("AlnPlotTcris_GSR1_GSR2.pdf",width=11,height=11)
par(mfrow=c(4,4))
par(mar=c(4.5,5.5,2.5,1.5))
for(i in 1:13){
	...
	plot(as.numeric(subd[1,12:13]),as.numeric(subd[1,16:17]),type='l',xlim=c(0,xub),ylim=c(0,yub),cex.lab=1.4,xlab="Refugio GS2",ylab="Refugio GS1")
	...
	for(j in 2:N){
		if(subd[j,9]=="++"){
			...
			lines(subd[j,12:13],sizes[which(tc_gsr1==chtab[i,3])]-subd[j,16:17],col="black")
		}
	}
}
dev.off()
...
dat_gsr1_gusr1<-fread(ff[[3]],header=FALSE)
...
par(mar=c(5,5,1,1))
image(ntab,axes=FALSE,xlab="T. cristinae (R GUS1)",ylab="T. cristinae (R GS1)",cex.lab=1.4)
axis(2,at=seq(0,13,length.out=13)/13,tc_gsr1,las=2)
...
pdf("AlnPlotTcris_GSR1_GUSR1.pdf",width=11,height=11)
par(mfrow=c(4,4))
par(mar=c(4.5,5.5,2.5,1.5))
for(i in 1:13){
	...
	plot(as.numeric(subd[1,12:13]),as.numeric(subd[1,16:17]),type='l',xlim=c(0,xub),ylim=c(0,yub),cex.lab=1.4,xlab="Refugio GUS1",ylab="Refugio GS1")
	title(main=paste("Chromosome",i),cex.main=1.4)
	N<-dim(subd)[1]
	for(j in 2:N){
		if(subd[j,9]=="++"){
...
#################################################################################
## now refugio GS1 vs GUS2
dat_gsr1_gusr2<-fread(ff[[4]],header=FALSE)
...
par(mar=c(5,5,1,1))
image(ntab,axes=FALSE,xlab="T. cristinae (R GUS2)",ylab="T. cristinae (R GS1)",cex.lab=1.4)
axis(2,at=seq(0,13,length.out=13)/13,tc_gsr1,las=2)
axis(1,at=seq(0,12,length.out=12)/12,tc_gusr1,las=2)
box()
dev.off()
...
pdf("AlnPlotTcris_GSR1_GUSR2.pdf",width=11,height=11)
par(mfrow=c(4,4))
par(mar=c(4.5,5.5,2.5,1.5))
for(i in 1:13){
	...
	plot(as.numeric(subd[1,12:13]),as.numeric(subd[1,16:17]),type='l',xlim=c(0,xub),ylim=c(0,yub),cex.lab=1.4,xlab="Refugio GUS2",ylab="Refugio GS1")
	title(main=paste("Chromosome",i),cex.main=1.4)
	N<-dim(subd)[1]
	for(j in 2:N){
		if(subd[j,9]=="++"){
...
dat_gsr2_gusr1<-fread(ff[[5]],header=FALSE)
...
par(mar=c(5,5,1,1))
image(ntab,axes=FALSE,xlab="T. cristinae (R GUS1)",ylab="T. cristinae (R GS2)",cex.lab=1.4)
...
pdf("AlnPlotTcris_GSR2_GUSR1.pdf",width=8.25,height=11)
par(mfrow=c(4,3))
par(mar=c(4.5,5.5,2.5,1.5))
for(i in 1:12){
	tcr_gusr1<-grep(x=subDfdat[,10],pattern=paste("old_",chtab[i,4],"_",sep="")) 
	...
	plot(as.numeric(subd[1,12:13]),as.numeric(subd[1,16:17]),type='l',xlim=c(0,xub),ylim=c(0,yub),cex.lab=1.4,xlab="Refugio GUS1",ylab="Refugio GS2")
	...
	for(j in 2:N){
		if(subd[j,9]=="++"){
			...
			lines(subd[j,12:13],sizes[which(tc_gsr2==chtab[i,3])]-subd[j,16:17])
		}
	}
}
dev.off()
...
dat_gsr2_gusr2<-fread(ff[[6]],header=FALSE)
...
par(mar=c(5,5,1,1))
image(ntab,axes=FALSE,xlab="T. cristinae (R GUS2)",ylab="T. cristinae (R GS2)",cex.lab=1.4)
axis(2,at=seq(0,12,length.out=12)/12,tc_gsr2,las=2)
...
pdf("AlnPlotTcris_GSR2_GUSR2.pdf",width=8.25,height=11)
par(mfrow=c(4,3))
par(mar=c(4.5,5.5,2.5,1.5))
for(i in 1:12){
	tcr_gusr2<-grep(x=subDfdat[,10],pattern=paste("old_",chtab[i,4],"_",sep="")) 
	...
	plot(as.numeric(subd[1,12:13]),as.numeric(subd[1,16:17]),type='l',xlim=c(0,xub),ylim=c(0,yub),cex.lab=1.4,xlab="Refugio GUS2",ylab="Refugio GS2")
	title(main=paste("Chromosome",chtab[i,1]),cex.main=1.4)
	N<-dim(subd)[1]
	for(j in 2:N){
		if(subd[j,9]=="++"){
...
dat_gusr1_gus<-fread(ff[[7]],header=FALSE)
...
par(mar=c(5,5,1,1))
image(ntab,axes=FALSE,xlab="T. cristinae (GUS main)",ylab="T. cristinae (R GUS1)",cex.lab=1.4)
...
#################################################################################
#################################################################################
## now refugio GUSR1 vs GUSR2 
dat_gusr1_gusr2<-fread(ff[[8]],header=FALSE)
...
par(mar=c(5,5,1,1))
image(ntab,axes=FALSE,xlab="T. cristinae (R GUS2)",ylab="T. cristinae (R GUS1)",cex.lab=1.4)
axis(2,at=seq(0,12,length.out=12)/12,tc_gusr1,las=2)
axis(1,at=seq(0,12,length.out=12)/12,tc_gusr2,las=2)
box()
dev.off()
...
pdf("AlnPlotTcris_GUSR1_GUSR2.pdf",width=8.25,height=11)
par(mfrow=c(4,3))
par(mar=c(4.5,5.5,2.5,1.5))
for(i in 1:12){
	...
	plot(as.numeric(subd[1,12:13]),as.numeric(subd[1,16:17]),type='l',xlim=c(0,xub),ylim=c(0,yub),cex.lab=1.4,xlab="Refugio GUS2",ylab="Refugio GUS1")
	title(main=paste("Chromosome",chtab[i,1]),cex.main=1.4)
	N<-dim(subd)[1]
	for(j in 2:N){
		if(subd[j,9]=="++"){
			...
			lines(subd[j,12:13],sizes[which(tc_gusr1==chtab[i,4])]-subd[j,16:17])
		}
	}
}
dev.off()
