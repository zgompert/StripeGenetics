...
of = "dd_mom_"+p1+"_"+p2+"_im.txt"
pngf = "dd_mom_"+p1+"_"+p2+"_im.png"

ofile = open(of,"w")

ns =  fs_proj.sample_sizes

## define IM model, includes exponential growth
def IMg(params, ns):
...
## define IM model, split into two pops
def IM(params, ns):
...
#upper_bound = [.9, 40, 40, 6, 5, 5]
#lower_bound = [.1, 0.1, 0.1, 0, 0, 0]

# Parameters are: (nu1, nu2, T, and m12, m21)
upper_bound = [100, 100, 20, 5, 5]
lower_bound = [0.1, 0.1, 0, 0, 0]

# This is our initial guess for the parameters, which is somewhat arbitrary.
#p0 = [0.5, 0.8, 1.2, 0.4, 0.5, 0.5]
p0 = [0.8, 1.2, 0.4, 0.5, 0.5]
np = len(p0)
...
#uncerts = moments.Godambe.FIM_uncert(func, popt, fs_proj)
